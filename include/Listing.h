...
public:
	 ...
	 */
	bool changePay(int lid, int64_t newPay);
	 ...
	 */
	bool changeSkillRequirements(int lid, std::map<std::string, std::string> newSkills);
	 ...
	 */
	bool changePersonalityTypes(int lid, std::string newPersonalityTypes);
