...
TEST(EmployerDeleteListing, checkDeleteListing)
{
        ...
        Listing *l = new Listing(*db);
        Employer *e = new Employer(*db, *l);
        int newLid = e->postListing(1, {{"field", "Education"}, {"position", "Education Consultant"}, {"job_description", "Develop and implement educational programs for schools and other institutions, providing guidance on curriculum and teaching strategies"}, {"location", "Boston"}}, {{"skill1_req", "Curriculum Development"}, {"skill2_req", "Teaching Experience"}, {"skill3_req", "Instructional Design"}, {"skill4_req", "Project Management"}, {"skill5_req", "Communication"}, {"personality_types", "ENFJ"}}, 65000, {{"job_flexibility", false}, {"modern_building", true}}, resCode);
        bool res = e->deleteListing(1, newLid, resCode);
        EXPECT_EQ(res, true);
